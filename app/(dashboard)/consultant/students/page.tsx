...
export default function MyStudentsPage() {
    ...
    // Logic Filtering berdasarkan Nama atau Program
        ...
        <div className="space-y-6 p-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                        Kelola data siswa, dokumen, dan log sesi konsultasi.
                    </p>
                </div>
            ...
            {filteredStudents.length > 0 ? (
                            ...
                            <div className="bg-white border border-slate-200 rounded-xl p-5 hover:border-blue-300 hover:shadow-md transition-all group cursor-pointer h-full flex flex-col">
                                ...
                                <div className="space-y-2 flex-grow">
                                    ...
                                    <div className="flex items-center gap-2 text-xs text-slate-600">
                                        ...
                                        <span>
                                            Sesi Terakhir: <strong>{student.lastSession}</strong>
                                        </span>
                                    </div>
                                </div>
                ...
                <div className="text-center py-12 bg-white rounded-xl border border-slate-200 text-slate-400">
                    <p className="text-sm">Tidak ada siswa yang cocok dengan kata kunci &ldquo;{searchQuery}&rdquo;</p>
                </div>
            )}
        </div>
    );
