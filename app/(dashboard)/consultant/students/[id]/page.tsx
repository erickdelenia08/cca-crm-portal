...
export default function StudentDetailPage() {
    ...
    const profile = {
        ...
        preferences:
            "Fokus ke universitas di Jerman (TU Munich, RWTH Aachen). Perlu bantuan intensif di Motivation Letter.",
    };
    ...
    const [notes, setNotes] = useState([
        {
            ...
            author: "Konsultan",
            content:
                "Review CV selesai. Struktur sudah bagus, hanya perlu penekanan di pengalaman proyek akhir. PR untuk Budi: Mulai draft poin-poin Motivation Letter.",
        },
        {
            id: 2,
            date: "20 Agu 2026",
            author: "Konsultan",
            content:
                "Sesi kickoff. Menentukan timeline pendaftaran dan shortlist universitas (TUM & RWTH). Budi berjanji upload transkrip besok.",
        },
    ]);
    ...
    return (
        <div className="space-y-6 p-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-3">
                            {documents.map((doc) => (
                                ...
                                >
                                    ...
                                    <span
                                        className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${doc.status === "verified"
                ...
                {/* Kolom Kanan: Meeting Notes & Log Interaksi */}
