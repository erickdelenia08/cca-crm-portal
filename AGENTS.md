...
5. 🔒 **RBAC & Authorization (Multi-Role):**
   👉 **Read `.agents/rules/rbac.md`** for strict role-based permission checks across Student, Consultant, Processor, and Admin roles.

6. 🗄️ **Database & Business Logic Domains:**
   👉 **Read `.agents/rules/db-schema.md`** for entities, booking limits, document tracker flow, attendance, and payroll rules.
